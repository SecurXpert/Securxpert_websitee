...
const cloudServices = {
  ...
  metaTitle: "Cloud Infrastructure Services Hyderabad | AWS, Azure, GCP specialists",
  metaDescription: "Certified cloud infrastructure services: multi-cloud migration, server management, DevOps automation & cost optimisation. Flat pricing, global delivery, on time",
  ...
  faqs: [
    {
      ...
      answer: "Depends on your infrastructure size and workloads. We offer fixed-price projects after a free assessment."
    },
    {
      id: 2,
      qNumber: "Q2.",
      question: "Which cloud platform is best: AWS, Azure, or GCP?",
      answer: "We assess your environment and recommend the right platform with no vendor bias — whatever fits your business, anywhere in the world."
    },
    {
      id: 3,
      qNumber: "Q3.",
      question: "How long does cloud migration take?",
      answer: "Small setups: 4–8 weeks. Large or complex environments: 3–6 months. Always planned, always on time."
    },
    {
      id: 4,
      qNumber: "Q4.",
    ...
    },
    {
      ...
      answer: "Yes. 24/7 monitoring, patching, cost optimisation, and support — all under one flat monthly price."
    },
    {
      id: 6,
      qNumber: "Q6.",
    ...
    },
    {
      ...
      answer: "Every project has a fixed timeline, clear milestones, and on-time delivery — guaranteed."
    },
    {
      id: 8,
      qNumber: "Q8.",
