          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                {/* Email Field */}
                <div className="flex flex-col">
                  <label className="text-slate-800 text-[11px] font-extrabold tracking-wider mb-2 font-inter">
                    EMAIL *
                  </label>
                  <input
                    type="email"
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="bg-[#3D62EB] hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-[6px] text-sm shadow-md transition-all active:scale-95"
                  >
                    Submit
                  </button>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full bg-white border border-slate-200 rounded-[6px] px-4 py-2.5 text-sm text-slate-500 focus:border-[#3D62EB] focus:outline-none appearance-none cursor-pointer font-sans"
                    >
                ...
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent border-b border-slate-200 focus:border-[#3D62EB] focus:outline-none pb-2 text-sm text-slate-800 placeholder-slate-400 font-sans resize-none mt-1 min-h-[160px]"
                  />
                </div>
