        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-16 pb-12">
          ...
          <div className="lg:col-span-3 flex flex-col items-start gap-5">
            ...
            <div className="flex flex-col items-start gap-4">
              {/* Map Address */}
              <a 
                href="https://www.google.com/maps/search/?api=1&query=Third+Floor,+PR+R+One+Towers,+Plot+No+59,+DLF+Rd,+near+Radisson+Hotel,+Jayabheri+Enclave,+Gachibowli,+Hyderabad,+Telangana+500032" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-start gap-3.5 group cursor-pointer"
              >
                <span className="text-[#3b82f6] mt-1 flex-shrink-0 group-hover:scale-110 transition-transform duration-200">
                ...
                <span className="text-[15px] leading-relaxed text-[#4f5b76] group-hover:text-[#3b82f6] transition-colors duration-200">
